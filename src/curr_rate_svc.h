...
{
    inline static constexpr auto CURR_LIST_REF = "https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies.json"sv;
    inline static constexpr auto CURR_LIST_RATE_BY_REF = "https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies/"sv;
